...
# 将二维码添加到指定图片上
def add_qrcode_to_image(qrcode_img, target_img, output_img_path):
    qr_img = qrcode_img
...
def process_image(input_url, target_img):
    ...
    # 将二维码添加到目标图片上
    add_qrcode_to_image(qr_img, target_img, output_img_path)
